...
const home_click = document.querySelector('.home_nav1')
const about_click = document.querySelector('.about_nav1')
const services_click = document.querySelector('.services_nav1')
const projects_click = document.querySelector('.projects_nav1')
const work_click = document.querySelector('.work_nav1')
const footer_click = document.querySelector('.footer_nav1')
const check_main = document.querySelector('.footer_main')
...
services_click.addEventListener('click', () => {
    window.scrollTo(0, 1228);
    
})
projects_click.addEventListener('click', () => {
    window.scrollTo(0, 1855);
    
})
work_click.addEventListener('click', () => {
    window.scrollTo(0, 3002);
    
})
footer_click.addEventListener('click', () => {
    window.scrollTo(0, 4357);
    
})

console.log(
    window.scrollY + check_main.getBoundingClientRect().top
)
...
const home_click2 = document.querySelector('.home_nav2')
const about_click2 = document.querySelector('.about_nav2')
const services_click2 = document.querySelector('.services_nav2')
const projects_click2 = document.querySelector('.projects_nav2')
const work_click2 = document.querySelector('.work_nav2')
const footer_click2 = document.querySelector('.footer_nav2')


home_click2.addEventListener('click', () => {
    window.scrollTo({
        top: 0,
...
about_click2.addEventListener('click', () => {
    window.scrollTo({
        top: 520
    });
    
})
services_click2.addEventListener('click', () => {
    window.scrollTo(0, 1228);
    
})
projects_click2.addEventListener('click', () => {
    window.scrollTo(0, 1855);
    
})
work_click2.addEventListener('click', () => {
    window.scrollTo(0, 3002);
    
})
footer_click2.addEventListener('click', () => {
    window.scrollTo(0, 4357);
